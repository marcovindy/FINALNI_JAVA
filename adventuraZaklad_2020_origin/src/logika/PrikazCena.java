...
public class PrikazCena implements IPrikaz {
    ...
    /**
     * Po zavolání příkazu se vypíše cena věci v obchodě
     *
     * @param parametry - Věc od které chci vědět cenu
     * @return - Vrací cenu věci, pokud je vše zadáno správně a je hráč v obchodě,
     * jinak zašle text, co hráč udělal špatně
     */
